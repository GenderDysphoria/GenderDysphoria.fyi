...
title: "Як виявляється гендерна дисфорія: ейфорія"
linkTitle: "Гендерна ейфорія"
description: "Щоб була тінь, мусить бути світло."
preBody: '_disclaimer'
lang: uk
siblings:
  prev: /uk/history
  prevCaption: Історія гендерної дисфорії
...
Перш ніж говорити про дискомфорт, я маю розповісти про полегшення. Гендерна ейфорія сама по собі є ознакою гендерної дисфорії. Ти можеш запитати себе: «Як щастя може бути смутком?» Відповідь проста.

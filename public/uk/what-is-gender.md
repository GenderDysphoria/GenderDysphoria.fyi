...
title: "Що таке гендер?"
description: "Як ми визначаємо поняття гендеру і чим воно відрізняється від статі?"
preBody: '_disclaimer'
lang: uk
siblings:
  prev: /uk/
  prevCaption: Вступ
  next: /uk/history
  nextCaption: Історія гендерної дисфорії
classes:
  - gdb
tweets:
  - '1228717614630940672'
...
<div class="gutter">
  <blockquote>
    <strong>Ген·дер</strong> - <em>Іменник</em><br>
...
- **[Гендер](https://uk.wikipedia.org/wiki/Гендер)**: **Не**спостережувані статеві ознаки, внутрішня ментальна модель власної статі людини та спосіб, у який вона її виражає.
...
Гендер, однак, значно... езотеричніший. Існує безліч різних способів, якими люди намагалися проілюструвати гендерний спектр, але жоден не передав його цілком вичерпно, адже та широта, яку охоплює гендер, сама собою є дуже абстрактним поняттям.
{!{
<div class="">
  <div class="card">
    <div class="card-header"><strong>Приклади методів, що використовуються для опису гендеру</strong></div>
    ...
    <div class="card-body">
      Зверни увагу, що ці три зображення різняться тим, скільки вимірів гендеру вони показують і які ознаки вимірюють.<br />
      <em>Джерела:</em>
...
Гендер — це почасти соціальний конструкт, почасти засвоєна поведінка, а почасти біологічні процеси, які формуються дуже рано в житті людини.
...
Гендер також впливає на очікування, які мозок має щодо середовища, у якому він перебуває (твого тіла), і коли це середовище не відповідає цим очікуванням, мозок здіймає тривогу у вигляді депресії, деперсоналізації, дереалізації та дисоціації. Це підсвідомі способи, якими мозок повідомляє нам, що щось дуже не так.
...
Експерименти Джона Мані мали на меті підтвердити його переконання, що гендер — це цілковито соціальний конструкт і що будь-яку дитину можна виховати так, щоб вона вважала себе тим, ким її навчили бути. Його експеримент зазнав цілковитого провалу (див. розділ «Біохімічна дисфорія»). Гендер не змінюється; кожна людина у 40 років має той самий гендер, що й у 4. Що змінюється — то це наше особисте розуміння власного гендеру в міру того, як ми дорослішаємо як особистості.
...
Небінарні ідентичності лежать поза винятковою спорідненістю лише з чоловічим або лише з жіночим. Іноді це означає повну спорідненість з обома ([бігендер](https://gender.fandom.org/wiki/Bigender)) або врівноважену спорідненість з обома ([андрогін](https://gender.fandom.com/wiki/Androgyne)). Це також може бути спорідненість, що змінюється день у день ([гендерфлюїд](https://gender.fandom.org/wiki/Genderfluid)), часткова спорідненість ([демігендер](https://gender.fandom.org/wiki/Demigender)) чи навіть спорідненість одразу з усім гендерним спектром ([пангендер](https://gender.fandom.org/wiki/Pangender)).

Це також може означати цілковиту відсутність спорідненості з будь-якою гендерною ідентичністю ([агендер](https://gender.fandom.org/wiki/Agender)) або сильну спорідненість із гендерною ідентичністю, що не співвідноситься ні з чоловічим, ні з жіночим (зокрема, але не лише, [апорагендер](https://gender.fandom.com/wiki/Aporagender)).
